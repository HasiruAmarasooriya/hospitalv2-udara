		...
		public IActionResult filterForm()
		{
			try
			{
				...
				switch (_OPDDto.InvoicedType)
				{
					...
					case 0:
						oPdDto.listopd = reportsService.GetAllOpdByAndDateRangePaidStatus(_OPDDto.StartTime,
							_OPDDto.EndTime, PaymentStatus.PAID, "OPD");
						oPdDto.listNeedToPayOPD =
							reportsService.GetAllOPDByDateRangeAndNeedToPayStatus(_OPDDto.StartTime, _OPDDto.EndTime,
								"OPD");
						oPdDto.listopdGrugs =
							reportsService.GetAllOpdGrugsByDateRangePaidStatus(_OPDDto.StartTime, _OPDDto.EndTime,
								"OPD");
						oPdDto.OPDPaymentData =
							reportsService.GetAllOPDPaymentsData(_OPDDto.StartTime, _OPDDto.EndTime, "OPD");
					...
					case 2:
						oPdDto.listOTHER = reportsService.GetAllOpdByAndDateRangePaidStatus(_OPDDto.StartTime,
							_OPDDto.EndTime, PaymentStatus.PAID, "Other");
						oPdDto.listNeedToPayOTHER =
							reportsService.GetAllOPDByDateRangeAndNeedToPayStatus(_OPDDto.StartTime, _OPDDto.EndTime,
								"Other");
						oPdDto.listOTHERGrugs =
							reportsService.GetAllOpdGrugsByDateRangePaidStatus(_OPDDto.StartTime, _OPDDto.EndTime,
								"Other");
						oPdDto.OTHERPaymentData =
							reportsService.GetAllOPDPaymentsData(_OPDDto.StartTime, _OPDDto.EndTime, "Other");
						
						return View("OtherIndex", oPdDto);

					// If the user selects the X-RAY option
					case 3:
						oPdDto.listXRAY = reportsService.GetAllOpdByAndDateRangePaidStatus(_OPDDto.StartTime,
							_OPDDto.EndTime, PaymentStatus.PAID, "X-RAY");
						oPdDto.listNeedToPayXRAY = reportsService.GetAllOPDByDateRangeAndNeedToPayStatus(
							_OPDDto.StartTime,
							_OPDDto.EndTime, "X-RAY");
						oPdDto.XRAYPaymentData =
							reportsService.GetAllOPDPaymentsData(_OPDDto.StartTime, _OPDDto.EndTime, "X-RAY");
