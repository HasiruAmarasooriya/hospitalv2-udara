		...
		public Model.CashierSession GetCashierSessionByID(int id)
		{
			...
			using (HospitalMgrSystem.DataAccess.HospitalDBContext dbContext = new HospitalMgrSystem.DataAccess.HospitalDBContext())
			{
				...
				if (result != null)
				{
					...
					result.totalCashAmountHandover = result.col10Total + result.col9Total + result.col8Total + result.col7Total + result.col6Total + result.col5Total + result.col4Total + result.col3Total + result.col2Total + result.col1Total;
